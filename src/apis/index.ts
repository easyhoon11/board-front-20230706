...
const DOMAIN = "http://3.35.50.214:4000";
...
export const postBoardRequest = async (
  ...
  const result = await axios
    .post(POST_BOARD_URL(), requestBody, authorization(token))
    .then((response) => {
...
export const postCommentRequest = async (
  ...
  const result = await axios
    .post(POST_COMMENT_URL(boardNumber), requestBody, authorization(token))
    .then((response) => {
...
export const putFavoriteRequest = async (
  ...
  const result = await axios
    .put(PUT_FAVORITE_URL(boardNumber), {}, authorization(token))
    .then((response) => {
...
export const fileUploadRequest = async (data: FormData) => {
  const result = await axios
    .post(FILE_UPLOAD_URL(), data, multipart)
    .then((response) => {
